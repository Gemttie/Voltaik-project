...
#Testing dummy
#/summon minecraft:armor_stand 8 70 12 {NoGravity:1b,Invulnerable:1b,Invisible:0b,CustomName:'{"text":"TPlayer Test Dummy1"}', CustomNameVisible:0b, Tags:["TPlayer"]}
...
#World1:
execute as @e[tag=LobbyHappiestDummy2] if score @s TpTimer2 matches 151 run execute as @e[tag=World1TpDummy1,tag=TpOnUseTag1] run tp @e[tag=TPlayer] 1 71 8
#World2:
execute as @e[tag=LobbyHappiestDummy2] if score @s TpTimer2 matches 151 run execute as @e[tag=World2TpDummy1,tag=TpOnUseTag1] run tp @e[tag=TPlayer] 1 71 11
#World3:
